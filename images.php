...
<img src="images/pictures.png" alt="pictures" /><br />
...
<?php
	if($_GET[id] > 0 && $_GET[id] < 9) $id = $_GET[id];
	else $id = 1;
?>
<center><iframe src="simple/<?php echo $id; ?>/index.html" width="920" height="625" frameborder="0"></iframe></center>
</div>
</div>
